...
6. If the user names a style, use the same read-only `resolve` command and missing/draft/invalid handling
   described in `write-content`. Do not mutate a profile to complete a copy request. Style cannot override facts,
