...
const PRE_KINDS_SNAPSHOT = [
  ...
  '.agent/workflows/remind.md',
  '.agent/workflows/research.md',
  '.agent/workflows/ship.md',
  '.agent/workflows/test.md',
  '.agent/workflows/tldr.md',
  '.agent/workflows/todo.md',
